//
//  KafkaProgressiveRingIndicatorFooter.m
//  KafkaExample
//
//  Created by Sooyo on 2018/8/30.
...
// 图标的下边距
static const CGFloat kIconTopMargin = 0.f;
...
@interface KafkaProgressiveRingIndicatorFooter ()
...
@implementation KafkaProgressiveRingIndicatorFooter
...
- (void)layoutUIComponents
{
    ...
    _imageView.frame = CGRectMake(xPos, kIconTopMargin, kDefaultIconSize, kDefaultIconSize);
}
